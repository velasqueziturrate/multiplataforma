 ...
 */
exports.getGlobalTSDir = function () {
    var errors = [];
 ...
 */
exports.getModuleAbsolutePath = function (filename, libDir) {
...
function getTSPackage(basedir) {
    ...
    if (!packageDir)
        throw new system_1.PackageError("Could not find typescript package in " + packageDir);
    ...
    /* Validate */
    if (name !== 'typescript')
        throw new system_1.PackageError("The package in " + packageDir + " is not TypeScript. Found: " + name + ".");
    return { version: version, packageFile: packageFile, packageDir: packageDir, config: getConfig(packageDir), libDir: path_1.default.join(packageDir, 'lib') };
}
